...
import 'package:logisticsmobile/features/dashboard/domain/usecases/load_management_dashboard_usecase.dart';

class ManagementDashboardCubit extends Cubit<ResourceState<ManagementDashboardData>> {
  ManagementDashboardCubit(this._load) : super(const ResourceState.initial());

  final LoadManagementDashboardUseCase _load;
